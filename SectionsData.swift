...
class SectionsData {
    func getSectionsFromData() -> [Section] {
        ...
        let rightRef = Section(title: "back right refrigerated", objects: [Item(name: "sweet italian creamer", quantity: 1, location: "back right refrigerated")!, Item(name: "juice", quantity: 1, location: "back right refrigerated")!, Item(name: "tillamook yogurt", quantity: 5, location: "back right refrigerated")!, Item(name: "tillamook sour cream", quantity: 1, location: "back right refrigerated")!])
